...
//use Sojf\DBAL\Schema\ColumnDiff; todo 事件使用到
...
//    protected $_eventManager;
     ...
     *
     * @var \Sojf\DBAL\Abstracts\KeywordList
     */
    protected $_keywords;
...
//    }
    ...
    public function getDoctrineTypeMapping($dbType)
    {
        ...
        if (!isset($this->doctrineTypeMapping[$dbType])) {
            throw new DBALException("Unknown database type ".$dbType." requested, " . get_class($this) . " may not support it.");
        }
...
//        }
     ...
     *
     * @param \Sojf\DBAL\Schema\Index|string $index
     * @param \Sojf\DBAL\Schema\Table|string $table
     *
     * @return string
     *
     ...
     *
     * @param \Sojf\DBAL\Interfaces\Constraint|string $constraint
     * @param \Sojf\DBAL\Schema\Table|string      $table
     *
     * @return string
     */
     ...
     *
     * @param \Sojf\DBAL\Schema\ForeignKeyConstraint|string $foreignKey
     * @param \Sojf\DBAL\Schema\Table|string                $table
     *
     * @return string
     */
    ...
    public function getCreateTableSQL(Table $table, $createFlags = self::CREATE_INDEXES)
    {
        ...
        foreach ($table->getColumns() as $column) {
            ...
            // todo: 关闭事件 onSchemaCreateTableColumn
...
//        }
     ...
     *
     * @param \Sojf\DBAL\Schema\ForeignKeyConstraint $foreignKey The foreign key constraint.
     ...
     *
     * @param \Sojf\DBAL\Schema\TableDiff $diff
     *
     * @return array
     *
     * @throws DBALException If not supported on this platform.
     ...
     *
     * @return boolean
     */ //todo: 关闭事件 onSchemaAlterTableAddColumn
...
//    }
     ...
     *
     * @return boolean
     */ //todo: 关闭事件 onSchemaAlterTableRemoveColumn
...
//    }
    ...
    /**
     * @param \Sojf\DBAL\Schema\ColumnDiff $columnDiff
     * @param \Sojf\DBAL\Schema\TableDiff  $diff
     * @param array                            $columnSql
     *
     * @return boolean
     */ //todo: 关闭事件 onSchemaAlterTableChangeColumn
...
//    }
     ...
     *
     * @return boolean
     */ //todo: 关闭事件 onSchemaAlterTableRenameColumn
...
//    }
     ...
     * @param \Sojf\DBAL\Schema\Index $index        The definition of the index to rename to.
     ...
     * @param \Sojf\DBAL\Schema\Index $index The index definition.
     *
     ...
     *
     * @param \Sojf\DBAL\Schema\ForeignKeyConstraint $foreignKey The foreign key definition.
     *
     * @return string
     */
     ...
     *
     * @return \Sojf\DBAL\Abstracts\KeywordList
     *
     ...
     * @throws \Exception
     */
    public function getSetTypeDeclarationSQL($fieldDeclaration)
    {
        if (!is_array($fieldDeclaration['list'])) {

            throw new \Exception('set list need array type');
        }

        $value = "'" . join("','", $fieldDeclaration['list']) . "'";
     ...
     * @throws \Exception
     */
    public function getEnumTypeDeclarationSQL($fieldDeclaration)
    {
        if (!is_array($fieldDeclaration['list'])) {

            throw new \Exception('enum list need array type');
        }
