...
use Sojf\DBAL\Query\Expression\CompositeExpression;
...
class QueryBuilder
{
    ...
    /**
     * @var \Sojf\DBAL\Query\Expression\ExpressionBuilder|Expression\ExpressionBuilder
     */
    public $expr;
     ...
     *
     * @param \Sojf\DBAL\Connection $connection The DBAL Connection.
     */
    public function __construct(Connection $connection)
    {
        $this->connection = $connection;
        $this->expr = $this->connection->getExpressionBuilder();
    }
     ...
     * @param $sql
     * @return \Sojf\DBAL\Interfaces\Statement|int
     */
    public function execute($sql = null)
    {
        ...
        if ($this->type == self::SELECT) {
            $data = $this->connection->executeQuery($sql, $this->params, $this->paramTypes);
        } else {
            $data = $this->connection->executeUpdate($sql, $this->params, $this->paramTypes);
        }
     ...
     *
     * @return \Sojf\DBAL\Query\QueryBuilder This QueryBuilder instance.
     */
    ...
    //todo 新加
    public function has($parts)
    {
        return $this->sqlParts[$parts] ? true : false;
    }
