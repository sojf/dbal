 ...
 * @since  2.0
 */
class ForeignKeyConstraint extends Asset implements Constraint
{
    /**
     ...
     * the foreign key constraint is associated with.
     *
     * @param \Sojf\DBAL\Schema\Table $table Instance of the referencing table.
     *
     * @return void
     */
     ...
     * @return array
     */
    public function getQuotedLocalColumns(Platform $platform)
    {
        $columns = array();
     ...
     * @return string
     */
    public function getQuotedForeignTableName(Platform $platform)
    {
     ...
     * @return array
     */
    public function getQuotedForeignColumns(Platform $platform)
    {
        $columns = array();
