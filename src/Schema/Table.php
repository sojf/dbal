...
class Table extends Asset
{
     ...
     * @return self
     */
    public function addIndex(array $columnNames, $indexName = null, $type='key', array $flags = array(), array $options = array())
    {
        if ($indexName == null) {
        ...
        return $this->_addIndex($this->_createIndex($columnNames, $indexName, $isUnique, $isPrimary, $flags, $options));
    }
